    ...
    return (
        <>
            ...
            <div style={{ textAlign: 'center' }}>
                ...
                {/* Recover Text Button - Blue */}
                <button onClick={RecoverBtnClicked} className='btn my-3 mx-3' style={{ backgroundColor: 'blue', color: 'white' }}>
                    Recover Text
                </button>
                
                {/* Bold Button - Pink */}
                <button onClick={BoldBtnClicked} className='btn my-3 mx-3' style={{ backgroundColor: 'pink', color: 'black' }}>
                    Bold
                </button>
                
                {/* Italic Button - Faint Blue */}
                <button onClick={ItalicBtnClicked} className='btn my-3 mx-3' style={{ backgroundColor: '#add8e6', color: 'black' }}>
                    Italic
                </button>
